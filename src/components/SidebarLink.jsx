...
export const SidebarLinkLogout = ({ to, text, children }) => {
    return (
        <Link to={to} className={'pl-4 flex items-center h-14 gap-3 hover:bg-red-600 hover:pl-8 transition-all ease-in-out duration-300 absolute bottom-0 max-md:bottom-20 w-full'}>
            {children}
