...
const Finished = () => {
  ...
  const loadRecommendations = async (rec) => {
  ...
  const loadResume = async () => {
    ...
    if (resume != null) {
      ...
      await getResume(questionsObject).then(response => {
        ...
        loadRecommendations(response.data.body.res)
      })
    }
  }
  ...
  const correctAnswers = questions.filter((question) => question.isCorrectUserAnswer)
  return (
